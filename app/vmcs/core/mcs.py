...
class MultiCameraSystem(object):
    ...
    def reconstruct_points_3d(self, images, draw=False):
        ...
        for (cam1, cam2), cam_pair in self.camera_pairs.items():
            ...
            world_xyz, color_img = matcher.reconstruct(disparity, rect_img1, cam_pair.Q, P=pose_refer_rect)
            if draw:
                pcd = o3d.geometry.PointCloud()
                pcd.points = o3d.utility.Vector3dVector(world_xyz)
                pcd.colors = o3d.utility.Vector3dVector(color_img / 255.0)
...
if __name__ == "__main__":
    ...
    #     _, _, _, disparity = cam_pair.stereo_disparity(images['cam1'], images['cam2'])
    #     plt.figure()
